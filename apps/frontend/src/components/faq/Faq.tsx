...
function Faq() {
  ...
  return (
    <>
      <div className="bg-white text-black min-h-screen transition-all duration-300 font-pop dark:bg-gray-800 dark:text-white">
        <Header />
        <div className="flex">
          <Vheader />
                    ...
                    >
                      ...
                      <span
                        className={`shrink-0 w-7 h-7 md:w-8 md:h-8 flex items-center justify-center rounded-full text-lg font-bold transition-all duration-300 ${
                          isOpen ? "rotate-45 bg-blue-500 text-white" : "bg-gray-300 text-black dark:bg-gray-700 dark:text-white"
                        }`}
                      >
                        +
                      </span>
