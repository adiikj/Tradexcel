...
export default function ChatMessageView({ message, showSuggestions, onSend, onNavigate, disabled }: Props) {
  ...
  if (message.role === "error") {
    return (
      <div className="flex max-w-[90%] flex-col items-start gap-2 rounded-2xl rounded-bl-md bg-red-50 px-3.5 py-2.5 text-sm text-red-700 dark:bg-red-500/10 dark:text-red-300">
